        ...
        function animate() {
            ...
            if (player && !gameWon && !gameOver) {
                ...
                if (thirdPerson) {
                    ...
                    const forward = new THREE.Vector3(0, 0, -1).applyAxisAngle(new THREE.Vector3(0, 1, 0), firstPersonCameraYaw);
                    const right = new THREE.Vector3(1, 0, 0).applyAxisAngle(new THREE.Vector3(0, 1, 0), firstPersonCameraYaw);
                    if (keys['w']) {
